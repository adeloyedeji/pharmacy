                                ...
                                <div class="col-lg-3 col-sm-6 text-danger-a300 p-l-30 p-r-40 mb-5 mb-sm-5 mb-lg-0 br-grey-100 br-lg br-dashed no-b-xs">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-8">
                                            ...
                                            <div class="x3 no-p no-m m-t-10 m-b-10"><?php echo e($users->count()); ?> <i class="icon-arrow-up16 text-success text-size-large"></i></div>
                                ...
                                <div class="col-lg-3 col-sm-6 text-success-a300 p-l-30 p-r-40 mb-5 mb-sm-5 mb-lg-0 br-grey-100 br-lg br-dashed no-b-xs no-b-sm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-8">
                                            ...
                                            <div class="x3 no-p no-m m-t-10 m-b-10">₦<?php echo e(number_format($sales->sum('amount'))); ?></div>
                                ...
                                <div class="col-lg-3 col-sm-6 text-info p-l-30 p-r-40 mb-5 mb-sm-0 br-grey-100 br-lg br-dashed no-b-xs">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-8">
                                            ...
                                            <div class="x3 no-p no-m m-t-10 m-b-10"><?php echo e($sales->count()); ?> <i class="icon-arrow-down16 text-danger text-size-large"></i></div>
                                ...
                                <div class="col-lg-3 col-sm-6 text-warning p-l-30 p-r-40">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-8">
                                            ...
                                            <div class="x3 no-p no-m m-t-10 m-b-10"><?php echo e($orders->count()); ?> <i class="icon-arrow-up16 text-success text-size-large"></i></div>
