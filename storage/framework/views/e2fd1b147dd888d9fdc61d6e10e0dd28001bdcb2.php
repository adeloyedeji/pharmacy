        ...
        <div class="row">
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="footer-about">
                    <img src="<?php echo e(URL::to('assets/img/logos/logo.png')); ?>" alt="" height="110" width="220" /><br />
                    
                    <ul>
                        <li><a href="#"><i class="fa fa-home"></i> Abuja </a></li>
                        <li><a href="#"><i class="fa fa-phone"></i> +2348147068805 </a></li>
                        <li><a href="#"><i class="fa fa-envelope"></i> info@dollarpharmacy.ng </a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-12 col-md-4 col-lg-4">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="footer-address">
                    <address>
                        &copy; <?php echo e(date('Y')); ?> DollarPharmacy. All Rights Reserved.<br>
                        <span>By <a href="http://istrategytech.com">Infostrategy Technology</a></span>
                        <div class="payment-logo">
                            <a href="#"> <img src="<?php echo e(URL::to('assets/img/prayment.png')); ?>" alt="" /></a>
                        </div>
                    </address>
                </div>
            </div>
