...
<div id="body-wrapper" class="body-container">
    ...
    <!-- Header begins -->
@include('partials.cms._header')

<!-- /Header ends -->

    <!-- Sidebar -->
@include('partials.cms._sidebar')
...
<!-- Global scripts -->
<script src="{{URL::to('cms_assets/lib/js/core/jquery/jquery.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/core/jquery/jquery.ui.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/core/tether.min.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/core/bootstrap/bootstrap.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/core/bootstrap/jasny_bootstrap.min.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/core/navigation/nav.accordion.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/core/hammer/hammerjs.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/core/hammer/jquery.hammer.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/core/slimscroll/jquery.slimscroll.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/extensions/smart-resize.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/extensions/blockui.min.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/forms/uniform.min.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/forms/switchery.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/forms/select2.min.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/plugins/ekko-lightbox.min.js')}}"></script>
...
<!-- Core scripts -->
<script src="{{URL::to('cms_assets/lib/js/core/app/layouts.js')}}"></script>
<script src="{{URL::to('cms_assets/lib/js/core/app/core.js')}}"></script>
<!-- /Core scripts -->
