<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{URL::to('cms_assets/lib/css/animate.min.cs')}}s">
    <link type="text/css" rel="stylesheet" href="{{URL::to('cms_assets/lib/css/metalgrey-material.css')}}">
    <!-- /Global stylesheets -->
