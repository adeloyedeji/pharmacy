...
<head>
    ...
    <!-- Global stylesheets -->
    <link type="text/css" rel="stylesheet" href="{{URL::to('cms_assets/lib/css/bootstrap.css')}}">
    <link type="text/css" rel="stylesheet" href="{{URL::to('cms_assets/lib/css/animate.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{URL::to('cms_assets/lib/css/main.css')}}">
    <!-- /Global stylesheets -->
</head>
    ...
    <div class="center-block">
            ...
            <div class="form">
                ...
                <form class="form-horizontal" method="POST" action="{{route('admin.login.submit') }}">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="input-group m-b-15 p-t-20 {{ $errors->has('email') ? ' has-error' : '' }}">
                            <div class="input-group-addon"><i class="icon-user"></i></div>
                            <input type="email" class="form-control" id="inlineFormInputGroup" name="email" placeholder="Email" value="{{ old('email') }}" required>
                            @if ($errors->has('email'))
                        ...
                        <div class="input-group m-b-15 {{ $errors->has('password') ? ' has-error' : '' }}">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="styled" type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> Remember me
                            </label>
                        </div>
        ...
        <div class="footer">
            <div class="float-left">
                ©  {{Date('Y')}} Dollar Pharmacy&nbsp;&nbsp;&nbsp;&bull;&nbsp;&nbsp;&nbsp; by <a href="http://www.istrategytech.com" target="_blank">Infostrategy Technology</a>.				</div>
